...
namespace APIVerve
{
    public class TextSummarizerAPIClient
    {
        ...
        public TextSummarizerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public TextSummarizerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(textsummarizerQueryOptions options)
        {
            try
            {
                if (_isDebug)
